...
export const KNOWN_RESOURCE_CATEGORIES = [
  "RG",
  "Storage",
  "NSG/ASG",
  "VM Windows",
...
const KNOWN_CATEGORY_CLASSES: Record<string, string> = {
  ...
  "VM Windows": "bg-[#818CF8]/12 text-[#93A8FF] border-[#33357A]",
  "VM Linux": "bg-[#A855F7]/11 text-[#CBA0FB] border-[#5A2D80]",
...
const KNOWN_CATEGORY_ICON: Record<string, string> = {
  ...
  "VM Windows":
    "M208,40H48A24,24,0,0,0,24,64V176a24,24,0,0,0,24,24H208a24,24,0,0,0,24-24V64A24,24,0,0,0,208,40Zm8,136a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V64a8,8,0,0,1,8-8H208a8,8,0,0,1,8,8ZM176,224a8,8,0,0,1-8,8H88a8,8,0,0,1,0-16h80A8,8,0,0,1,176,224Z",
  "VM Linux":
    "M117.31,134,68.24,177.09a8,8,0,1,1-10.54-12l40.2-35.3-40.2-35.29a8,8,0,1,1,10.54-12l49.07,43.09a8,8,0,0,1,0,12.42ZM208,176H128a8,8,0,0,0,0,16h80a8,8,0,0,0,0-16Z",
