...
tags_always = {
  ...
  Deployment = "terraform/00-Model-Resources/003-WIN-MARKET-VMROLE1"
}
...
# Specify the SKU of the image to create the VM
# vm1_image_sku = "2019-datacenter-gensecond"
# vm1_image_sku = "2016-datacenter-gensecond"
vm1_image_sku = "2022-datacenter-azure-edition-hotpatch"

# Specify the offer of the image to create the VM
# vm1_image_offer = "windowsserver"
vm1_image_offer = "windowsserver2022"

# Specify the version of the image - default = "latest"
...
vm1_patch_mode = "AutomaticByPlatform"
...
tags_vm1 = {
  # free-form text
  Description = "WIN MARKET VM TF Model"
...
# # Specify the SKU of the image to create the VM
# vm2_image_sku = "2019-datacenter-gensecond"
# # vm2_image_sku = "2016-datacenter-gensecond"
# # vm2_image_sku = "2022-datacenter-azure-edition-hotpatch"

# # Specify the offer of the image to create the VM
# vm2_image_offer = "windowsserver2022"
...
# # Specfiy the patch mode for the Windows VM
# # Allowed values : Manual, AutomaticByOS (default) and AutomaticByPlatform
# vm2_patch_mode = "AutomaticByPlatform"

# # Regular or Spot
# vm2_priority = "Regular"
...
#  # general_group1, general_group2, general_group3
#  # none
#   Maintenance_Group = "pilot_group1"
