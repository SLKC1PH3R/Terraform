...
tags_always = {
  ...
  Deployment = "terraform/00-Model-Resources/003-LNX-MARKET-VMROLE1"
}
...
# Specify the publisher of the image to create the VM
vm1_image_publisher = "Canonical"

# Specify the offer of the image to create the VM
vm1_image_offer = "0001-com-ubuntu-server-jammy"

# Specify the SKU of the image to create the VM
vm1_image_sku = "22_04-lts-gen2"
...
tags_vm1 = {
  # free-form text
  Description = "TF Model for Linux VM from Azure Marketplace"
...
# # Specify the offer of the image to create the VM
# vm2_image_offer = "0001-com-ubuntu-server-jammy"

# # Specify the SKU of the image to create the VM
# vm2_image_sku = "22_04-lts-gen2"
